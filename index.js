...
//
const BotName = 'Bool_BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/Kang_p_wkwkwk'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/628190828896'; // Nomor whatsapplu cok
const kapanbotaktif = '09.00-20.00'; // Kapan bot lu aktif
const grupch1 = 'KAGA ADA'; // OFFICIAL GRUP LU 1
const grupch2 = 'KAGA ADA'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Ru_BOT`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Ru_BOT`)
})
